...
class StructuralAnalysisGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        icon_path = Path(__file__).resolve().with_name("istockphoto-1077739826-1024x1024.ico")
        if icon_path.exists():
    ...
    def get_shortcuts_content(self):
        ...
        try:
            ...
            help_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'aide.html')
    ...
    def show_text_report(self):
        ...
        report_path = Path(__file__).resolve().with_name("RAPPORT_CALCUL.txt")
...
""")
    ...
    def _show_calculation_success(self, exe_name: str, working_dir: str):
        ...
        from automation_config import get_automation_setting
